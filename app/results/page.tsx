...
import { LeetCodePieChart } from "@/components/chart/LeetcodePieChart";
import GithubStats from "@/components/chart/GithubStats";
            ...
            {extractedUserData?.leetcodeSolvedProblems && (
              <div className="mt-3">
                <LeetCodePieChart
                  ...
                  medium={extractedUserData.leetcodeSolvedProblems.medium}
                  hard={extractedUserData.leetcodeSolvedProblems.hard}
                />
              </div>
            )}
            {extractedUserData?.githubUsername && (
              <div className="mt-3 flex justify-center">
                <GithubStats githubUserName={extractedUserData.githubUsername} />
              </div>
            )}
          </div>
